...
export function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
    ...
    const handleOAuthLogin = async (provider: 'google' | 'github') => {
        try {
            ...
            // ── FULL PAGE REDIRECT ──
            // We abandon popups entirely to solve COOP security blocks.
            // callback.html will handle the code exchange and redirect back.
            console.log(`[Auth] Redirecting to ${provider} OAuth...`);
